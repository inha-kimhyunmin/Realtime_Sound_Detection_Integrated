...
DANGET_DETECT_MODEL_PATH = 'model/Danger_detect/yamnet_lstm_model_20250815_224127.h5'
CALIBRATION_RESULT_PATH = 'calibration_result.json'
MIC_NUM = 1 #채널 수(시연시는 1로 조절)
...
#환경 소리 판단 클래스
CLASSES = ['Silence', 'Factory', 'Fire', 'Gas_Leak', 'Scream', 'Others(Talking)']
#공장 클래스 번호
...
USE_MUTE_BY_FACTORY_SOUND = False 
